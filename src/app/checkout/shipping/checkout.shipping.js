...
function CheckoutShippingController($exceptionHandler, $rootScope, $scope,  $state, toastr, LineItemsList, CurrentPromotions, ocConfirm, CategoryList, ProductList, OrderCloud, MyAddressesModal, AddressSelectModal, ShippingRates, CheckoutConfig) {
    var vm = this;
